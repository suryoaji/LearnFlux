...
class DatePickerDialog: UIView {
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.addTarget(self, action: #selector(self.buttonTapped), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.doneButton.addTarget(self, action: #selector(self.buttonTapped), forControlEvents: UIControlEvents.TouchUpInside)
