	...
	public View getView(int position, View conView, ViewGroup parent){
		...
		if(e != null){
			...
			if (e.getType().equalsIgnoreCase("plain")){
				if (e.getSender().getFirstName().equalsIgnoreCase("me")){
					...
					viewHolder.timestamp.setText(timeStampFormatter.format(((PlainChatBubble) e).getCreatedAt().getTime()));
				...
				if (e.getSender().equalsIgnoreCase("me")){
					...
					viewHolder.timestamp.setText(timeStampFormatter.format(((EventChatBubble) e).getCreatedAt().getTime()));
				...
				if (e.getSender().equalsIgnoreCase("me")){
					...
					viewHolder.timestamp.setText(timeStampFormatter.format(((PollChatBubble) e).getCreatedAt().getTime()));
					viewHolder.bubbleLayout.setOnClickListener(new View.OnClickListener() {
						@Override
						public void onClick(View v) {
							//do something
