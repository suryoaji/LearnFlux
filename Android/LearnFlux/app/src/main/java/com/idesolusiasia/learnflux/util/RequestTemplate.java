...
public class RequestTemplate {
	...
	public static void PATCHJsonRequest(final Context context, final String url, final JSONObject params,
										final ServiceCallback callback, final ErrorCallback errorCallback){
		final JsonObjectRequestWithNull jsonObjectRequest= new JsonObjectRequestWithNull(Request.Method.PATCH, url, params, new Response.Listener<JSONObject>() {
			@Override
			public void onResponse(JSONObject response) {
				callback.execute(response);
			}
